...
### Griefing
* The raiding of unclaimed containers (chests, barrels, anything that stores items) is alright, so long as they are not shop chests.
...
### Copyright
* Selling copyrighted maps that you did not create will result in the removal of your shop and potentially a ban.
...
* Use only English in the main chat. You are allowed to use other languages in private messages, such as /msg or party chat.
...
* If you discover a server bug, **do not** exploit it for your gain. Report this issue directly to an administrator.
...
* Intentionally spreading misinformation to hurt the server's image or any of its staff or players is strictly bannable.
...
* If you have questions about someone's ban or punishment, feel free to message a staff member about it **privately**. Do not take it to general chat. Bans are public and posted [here](https://bans.firestartermc.com/bans.php).

### Inappropriate skins and names
* Any skin or username deemed inappropriate by the staff will result in a ban until it is changed. 
* This also goes for item names in-game.

### Scope of moderation
* We do **not** moderate anything that takes place outside of the bounds of our server. We will only moderate actions on the Firestarter Realms or within the Firestarter Discord server. Anything outside of that is out of our scope of moderation, and you are responsible for moderating yourself.
...
### Common Sense
* If you have it, use it. If you don't, good luck.
* Common sense is somewhat subjective, so punishments in regards to this will are open to discussion. Punishments regarding "Common Sense" will be added to the rules for future reference.
* "Common Sense" punishments so far
* Not stopping a discussion when an Admin told them to stop.
